...
#' @param individual.variables boolean specifying if variables are grouped or individual
#' @param output.as.table boolean to specify if output should be a table or not
